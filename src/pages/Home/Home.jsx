...
const Home = () => {
  ...
  return (
    <section className="py-4">
        <Container className='text-center text-black pt-5 px-3'>
            <h1 className='fw-bold mb-0'>Hi, I'm Yusni Anggara, <br/>{professions[profession]}</h1>
            ...
            <div className='d-flex justify-content-center gap-3'>
                <Link className="btn btn-outline-dark btn-lg" to={"/works"}>See my work</Link>
                <a
                    href={cv}
                    download="CV_YusniAnggara.pdf"
            ...
            <div className='py-4'>
                <p className="fs-4 mb-0 fw-medium text-secondary">Find Me On</p>
                <div className='d-flex justify-content-center gap-3 fs-2'>
                  <a className="" href=""><BsTwitter /></a>
                  <a className="" href=""><BsLinkedin /></a>
                  <a className="" href=""><BsGithub /></a>
                </div>
            </div>
        </Container>
    </section>
